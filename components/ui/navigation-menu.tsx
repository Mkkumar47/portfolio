...
type PositionerAlign = ComponentProps<typeof NavigationMenuPrimitive.Positioner>["align"]
...
function NavigationMenu({
  ...
  children,
  ...props
}: ComponentProps<typeof NavigationMenuPrimitive.Root> & { align?: PositionerAlign }) {
  return (
